    ...
    <div className="border-t border-kerninkGrayDark mt-[100px] py-8">
        <div className="sm:flex justify-between items-center px-5 md:px-10">
            ...
            <ul className="flex flex-col mb-5">
                <a className="text-kerninkWhite font-poppinsRegular text-lg sm:text-xl hover:text-kerninkYellow" href="tel:+">+57 123 456 7890</a>
                <a className="text-kerninkWhite font-poppinsRegular text-lg sm:text-xl hover:text-kerninkYellow" href="mailto:">info@kerninkestudio.com</a>
            </ul> 
